...
// ============ EMAIL SERVICE ============
// Handles all email notifications: alerts, weekly reports, scheduled reports

// Create transporter (configure in settings)
...
export async function sendAlertEmail(alerts) {
  ...
  await transporter.sendMail({
    from: `"SEO Dashboard" <${getTransporter()?.options?.auth?.user}>`,
    to: emailTo,
